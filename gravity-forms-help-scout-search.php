	...
	?>
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				...
				jQuery('#request-ticket').click(function(evt){
					evt.preventDefault();
					jQuery('.support-form').toggle();
				});
				...
				field.keyup(function(e) {
					...
					var html = '<ul class="docs-search-results"><li class="docs-search-results-title">Please review our complete list of suggestions to proceed.</li>';
